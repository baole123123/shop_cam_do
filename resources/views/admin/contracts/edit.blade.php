                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col"><label class="form-label">Số CCCD</label>
                                        <input type="text" class="form-control" placeholder="Số CCCD"
                                            name="customer_identi" value="{{ $item->customer_identi }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col"><label class="form-label">Tổng tiền vay</label>
                                        <input type="text" class="form-control" placeholder="Tổng tiền vay"
                                            name="total_loan" value="{{ $item->total_loan }}">
                                        @error('total_loan')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col"><label class="form-label">Ngày trả</label>
                                        <input type="date" class="form-control" placeholder="Ngày trả"
                                            name="date_paid" value="{{ $item->date_paid }}">
                                        @error('date_paid')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
